                    ...
                    <form action="/products/{{$product->id}}/update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="c3">
                                ...
                                <div class="image-preview" id="default-image" style="position: relative; width: 100px; height: 100px;">
                                    <img id="img-preview" src="{{ asset('products/'.$product->image) }}" width="100" height="100" alt="Default Image" />
                                    <button class="delete-button" onclick="deleteImage('default-image')" style="position: absolute; top: 0; right: 0;">&#10006;</button>
                                </div>
                            </div>
                            </div>
                        </div>
